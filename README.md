...
# Meal Generator 
This is a simple random meal generator project using javaScript and create json api server where data comes from it to ui.

## Project Specifications

+ Created a simple UI(user interface).
+ Initial state have one button.
+ If click on GET MEAL button then random value dynamically changed from api. 


## Project Picture

![Meal Generator!](/src/images/meal.PNG "Meal Generator")
